...
const CreateCampaignDTO: z.ZodType<CreateCampaignDTO> = z
  .object({ name: z.string(), channel: Channel, budget: z.number(), start: z.string(), end: z.string() })
  .passthrough();
...
const CampaignViewModel: z.ZodType<CampaignViewModel> = z
  ...
  .passthrough();
const GetAllCampaignsDTO: z.ZodType<GetAllCampaignsDTO> = z
  .object({ count: z.unknown(), campaigns: z.array(CampaignViewModel) })
  .partial()
  .passthrough();
