...
const LINE_COLORS = ["#4f46e5", "#06b6d4", "#10b981", "#f59e0b", "#ef4444", "#8b5cf6", "#ec4899", "#f97316"];
...
export const CampaignTimelineChart: React.FC<CampaignTimelineChartProps> = ({ campaigns }) => {
  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow">
      <h3 className="mb-4 text-lg font-medium text-gray-900">Campaign Timeline</h3>
      <div className="h-96">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis dataKey="date" tickFormatter={(date) => format(parseISO(date), "MMM yy")} />
            ...
            <Line type="monotone" dataKey="total" stroke="#000000" strokeWidth={3} dot={false} name="Total Budget" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
